 ...
 */
export interface SagenftQueryParamsResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryListNftItem
   * @summary Queries a list of ListNftItem items.
   * @request GET:/blog/sagenft/list_nft_item
   */
  queryListNftItem = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<SagenftQueryListNftItemResponse, RpcStatus>({
   ...
   * @request GET:/blog/sagenft/params
   */
